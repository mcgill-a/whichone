// main.js
const inA = { spotify_id: 1234 /* create your moduleA dependencies in or before this line */ };
const outA = { /* you can add export properties with null values to enforce your contract, for example if you are using typescript */ };
moduleA(inA, outA);
